...
export const labelTools = [
  ...
  },
  {
    ...
    description:
      "Get all labels on a card. Use this tool to see the labels applied to a card.",
    inputSchema: {
      type: "object",
      properties: {
        cardId: {
  ...
  },
  {
    ...
    description:
      "Remove a label from a card. Use this tool to update the categorization of a card.",
    inputSchema: {
      type: "object",
      properties: {
        cardId: {
