...
export const boardTools = [
  {
    name: "get_boards",
    description:
      "Retrieve a list of boards for the authenticated user. Use this tool to get an overview of available boards or to search for specific ones using filters.",
    inputSchema: {
      type: "object",
      properties: {
        filter: {
        ...
        fields: {
          ...
          items: { type: "string" },
          description:
            "Specific fields to include in the response (default: all fields)",
        },
      },
    },
  },
  {
    name: "get_board",
    description:
      "Retrieve detailed information about a specific board by ID. Use this when you need comprehensive details about a particular board.",
    inputSchema: {
      type: "object",
      properties: {
        boardId: {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        defaultLabels: {
          type: "boolean",
          description:
            "Whether to use the default set of labels (default: true)",
        },
        defaultLists: {
          type: "boolean",
          description:
            "Whether to add the default set of lists (To Do, Doing, Done) (default: true)",
        },
        idBoardSource: {
          type: "string",
        ...
        prefs_selfJoin: {
          type: "boolean",
          description:
            "Whether organization members can join the board themselves (default: true)",
        },
        prefs_cardCovers: {
          type: "boolean",
    ...
    inputSchema: {
      ...
      properties: {
        ...
        subscribed: {
          type: "boolean",
          description:
            "Whether the authenticated user is subscribed to the board",
        },
        idOrganization: {
          type: "string",
          description: "ID of the organization the board should belong to",
        ...
        prefs_selfJoin: {
          type: "boolean",
          description:
            "Whether organization members can join the board themselves",
        },
        prefs_cardCovers: {
          type: "boolean",
  ...
  },
  {
    name: "delete_board",
    description:
      "Permanently delete a board. Use this tool with caution as deletion cannot be undone.",
    inputSchema: {
      type: "object",
      properties: {
        boardId: {
  ...
  {
    name: "get_board_members_list",
    description:
      "Get all members of a board. Use this tool to see who has access to a board.",
    inputSchema: {
      type: "object",
      properties: {
        boardId: {
  ...
  },
  {
    ...
    description:
      "Get all labels on a board. Use this tool to see the available labels on a board.",
    inputSchema: {
      type: "object",
      properties: {
        boardId: {
  ...
  },
  {
    name: "reopen_board",
    description:
      "Reopen a closed board. Use this tool to unarchive a previously archived board.",
    inputSchema: {
      type: "object",
      properties: {
        boardId: {
