...
export const memberTools = [
  ...
  },
  {
    name: "get_member",
    description:
      "Retrieve information about a specific member by ID or username. Use this to get details about another Trello user.",
    inputSchema: {
      type: "object",
      properties: {
        memberIdOrUsername: {
  ...
  },
  {
    ...
    description:
      "Get organizations that a member belongs to. Use this to see what workspaces a member is part of.",
    inputSchema: {
      type: "object",
      properties: {
        memberIdOrUsername: {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        limit: {
          ...
          maximum: 1000,
          description:
            "Maximum number of notifications to return (max 1000, default: 50)",
        },
      },
    },
  },
  {
    name: "update_me",
    description:
      "Update the authenticated member's information. Use this to modify your own profile details.",
    inputSchema: {
      type: "object",
      properties: {
        fullName: {
    ...
    inputSchema: {
      ...
      properties: {
        size: {
          ...
          description:
            "Size of the avatar (30, 50, 170, or original) (default: original)",
        },
      },
    },
  },
  {
    name: "search_members",
    description:
      "Search for members by name. Use this to find Trello users by their name or username.",
    inputSchema: {
      type: "object",
      properties: {
        query: {
        ...
        limit: {
          ...
          maximum: 20,
          description:
            "Maximum number of results to return (max 20, default: 8)",
        },
      },
      required: ["query"],
    },
  ...
  {
    name: "get_members_of_board",
    description:
      "Get members of a board. Use this to see who has access to a board.",
    inputSchema: {
      type: "object",
      properties: {
        boardId: {
  ...
  },
  {
    ...
    description:
      "Get members assigned to a card. Use this to see who is responsible for a task.",
    inputSchema: {
      type: "object",
      properties: {
        cardId: {
